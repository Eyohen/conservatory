...
const Sidebar = () => {
  ...
  return (
    ...
    <div className='flex justify-center h-screen px-[30px]'>
        ...
        <Link to={'/bookingtable'}> <div className='flex gap-x-3 items-center hover:bg-blue-200  px-2 mt-6 rounded'>
        <BiPurchaseTag />
        <p className='py-1 text-center'>Bookings</p>
        </div></Link>

        <Link to={'/menutable'}> <div className='flex gap-x-3 items-center hover:bg-blue-200  px-2 mt-6 rounded'>
        <TbCategory />
        <p className='py-1 text-center'>Menus</p>
        </div></Link>

        <Link ><div className='flex gap-x-3 items-center hover:bg-blue-200  px-2 mt-6 rounded'>
        <GoPackage />
        <p className='py-1 text-center'>Teas</p>
        </div></Link>

        <Link to={'/crockerytable'}><div className='flex gap-x-3 items-center hover:bg-blue-200  px-2 mt-6 rounded'>
        <PiNotepad />
        ...
        <div className='bg-[#F08E1F] text-white rounded-full w-11 h-11 flex justify-center text-2xl items-center'>{user?.fname.charAt()}</div>
        <div>
        ...
        <Link to={'/admin'}><div className='flex items-center gap-x-3 mt-9 justify-center'>
        <CiLogout />
