...
//           date:startDate,
//            time:timeSlot,
//           //  date:"2024-07-09T08:29:08.000Z"
//         });
//         if(res.status === 200){
//           setAvailability(res.data.available ? "This time is Available" : "This time is Unavailable");
//           console.log("available time", res.data.available)
//         }
//       } catch (err) {
